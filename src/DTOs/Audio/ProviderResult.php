...
/**
 * Provider-specific result DTO for text-to-speech async jobs.
 *
 * Represents the output from a single AI provider's text-to-speech processing,
 * including status, audio data, voice type, and resource URL.
 */
final readonly class ProviderResult
{
     ...
     *
     * @param string $provider The provider identifier (e.g., 'amazon', 'lovoai')
