...
final class TextToSpeechAsyncRequest extends AbstractRequestDTO
{
    ...
    /**
     * Create a new asynchronous text-to-speech request using fluent factory method.
     *
     * This factory method provides a convenient way to create asynchronous text-to-speech
     * requests with sensible defaults. The voice option defaults to FEMALE if not specified,
